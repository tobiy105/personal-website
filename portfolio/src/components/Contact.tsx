        ...
        <div className='bg-gray-700 bg-opacity-60 border border-accent p-8 rounded-md'>    
            <div className='grid md:grid-cols-2 gap-10'>
                <div className='space-y-8'>
                    ...
                    <p className='text-white' >I'm currently looking for full-time Software Engineering or Machine Learning opportunities! If you know of any positions available, have any questions, or want to say hi, please feel free to call or email me, contact me at my Linkedin, or send me a message by submitting the form.</p>
